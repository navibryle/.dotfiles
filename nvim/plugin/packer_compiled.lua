...
_G.packer_plugins = {
  ...
  firenvim = {
    loaded = true,
    path = "/home/ivan/.local/share/nvim/site/pack/packer/start/firenvim",
  ...
  ["neovim-ayu"] = {
    loaded = true,
    path = "/home/ivan/.local/share/nvim/site/pack/packer/start/neovim-ayu",
  ...
  ["vim-obsession"] = {
    loaded = true,
    path = "/home/ivan/.local/share/nvim/site/pack/packer/start/vim-obsession",
